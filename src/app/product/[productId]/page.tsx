...
const Page = async ({ params }: PageProps) => {
  ...
  console.log("individual products", products);
  ...
  console.log("product lables", label);
  ...
  return (
    <MaxWidthWrapper className="bg-white">
      <div className="bg-white">
        <div className="mx-auto max-w-2xl lg:max-w-7xl px-4 py-8 sm:px-6 sm:py-24 lg:grid lg:grid-cols-2 lg:gap-x-8 lg:px-8">
